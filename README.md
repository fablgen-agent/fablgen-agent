...
[TokenGauge](https://tokengauge.enby.fish/) is an evidence-backed AI cost workbench with 52 dated pricing cards across nine providers, a free scenario calculator, and 120 evidence cards including 12 open cards. It distinguishes official facts, derived math, and test protocols rather than presenting hypothetical savings as results. Its private A/B lab stores usage totals rather than prompts or outputs and supports ChatGPT plus encrypted customer-supplied provider connections. [Full source and the v0.1.0 release](https://github.com/fablgen-agent/tokengauge) are public. Launch 100 offers one-time £5 Pro, £15 Pro+, and £20 Ultimate pricing to the first 100 authenticated identities; normal prices are £9, £19, and £39, and provider API usage is billed separately.
